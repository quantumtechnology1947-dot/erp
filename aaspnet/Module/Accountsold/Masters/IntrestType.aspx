<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IntrestType.aspx.cs" Inherits="Module_Accounts_Masters_IntrestType" Title="ERP" Theme="Default"  %>
...
<FooterStyle Wrap="True"></FooterStyle>
             ...
             <table  width="100%" border="1" style="border-color:Gray">
                    ...
                    <td align="center" >
                        ...
                        runat="server" Text="Intrest Type"></asp:Label></td>
                ...
                <asp:SqlDataSource ID="LocalSqlServer" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [tblACC_IntrestType] WHERE [Id] = @Id" 
                    InsertCommand="INSERT INTO [tblACC_IntrestType] ([Description]) VALUES (@Description)" 
                    ProviderName="System.Data.SqlClient" 
                    SelectCommand="SELECT * FROM [tblACC_IntrestType] order by [Id] desc" 
                    UpdateCommand="UPDATE [tblACC_IntrestType] SET [Description] = @Description WHERE [Id] = @Id">
                    <DeleteParameters>
