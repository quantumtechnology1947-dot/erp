<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Octori.aspx.cs" Inherits="Module_Accounts_Masters_Octori" Title="ERP" Theme="Default" %>
...
<FooterStyle Wrap="True"></FooterStyle>
                    <Columns>
                       ...
                       <%# Container.DataItemIndex+1 %>
                        ...
                        <EditItemTemplate>
                        <asp:TextBox ID="txtTerms1" Width="90%" runat="server" Text='<%#Bind("Terms") %>'>
                        </asp:TextBox>
                        ...
                        <FooterTemplate>
                        <asp:TextBox ID="txtTerms2" runat="server" Width="90%">
                        </asp:TextBox>
                        ...
                        <EditItemTemplate>
                        <asp:TextBox ID="txtValue1" Width="60%" runat="server" Text='<%#Bind("Value") %>'>
                        </asp:TextBox>
                        ...
                        <FooterTemplate>
                        <asp:TextBox ID="txtValue2" runat="server" Width="60%">
                        </asp:TextBox>
               ...
               <tr>
                ...
                <td>
                   <asp:TextBox ID="txtTerms3" runat="server" Width="230" />
                   ...
                   <td>
                   <asp:TextBox ID="txtValue3" runat="server" Width="50%" />
