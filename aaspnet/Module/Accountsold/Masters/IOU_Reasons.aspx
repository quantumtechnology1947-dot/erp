<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IOU_Reasons.aspx.cs" Inherits="Module_Accounts_Masters_IOU_Reasons" Title="ERP" Theme="Default" %>
...
<FooterStyle Wrap="True"></FooterStyle>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [tblACC_IOU_Reasons] WHERE [Id] = @Id" 
                    InsertCommand="INSERT INTO [tblACC_IOU_Reasons] ([Terms]) VALUES (@Terms)" 
                    SelectCommand="SELECT * FROM [tblACC_IOU_Reasons]  order by [Id] desc" 
                    UpdateCommand="UPDATE [tblACC_IOU_Reasons] SET [Terms] = @Terms  WHERE [Id] = @Id">
                    <DeleteParameters>
