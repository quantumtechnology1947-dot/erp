<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TourExpencess.aspx.cs" Inherits="Module_Accounts_Masters_TourExpencess" Title="ERP" Theme="Default" %>
...
<FooterStyle Wrap="True"></FooterStyle>
                   ...
                   <Columns>
                      <asp:CommandField ButtonType="Link"  ShowEditButton="True" 
                        ...
                        <EditItemTemplate>
                        <asp:TextBox ID="txtTerms1" Width="90%" runat="server" CssClass="box3"  ValidationGroup="Shree" Text='<%#Bind("Terms") %>'>
                        </asp:TextBox>
                        ...
                        <FooterTemplate>
                        <asp:TextBox ID="txtTerms2" CssClass="box3"   Width="90%" ValidationGroup="abc" runat="server">
                        </asp:TextBox>
                   ...
                   <td>
                   <asp:TextBox ID="txtTerms3" CssClass="box3"  runat="server" ValidationGroup="pqr" Width="90%" > </asp:TextBox> 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [tblACC_TourExpencessType] WHERE [Id] = @Id" 
                    InsertCommand="INSERT INTO [tblACC_TourExpencessType] ([Terms]) VALUES (@Terms)" 
                    SelectCommand="SELECT * FROM [tblACC_TourExpencessType]  order by [Id] desc" 
                    UpdateCommand="UPDATE [tblACC_TourExpencessType] SET [Terms] = @Terms  WHERE [Id] = @Id">
                    <DeleteParameters>
