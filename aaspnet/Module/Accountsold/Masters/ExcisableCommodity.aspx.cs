...
public partial class Module_Accounts_Masters_ExcisableCommodity : System.Web.UI.Page
{
      ...
      try
        {  
            ...
            string strTerms = ((TextBox)row.FindControl("txtTerms1")).Text;
                        ...
                        {
                            con.Open();
                            string upd = "UPDATE tblExciseCommodity_Master SET Terms ='" + strTerms + "' WHERE Id ='" + id + "'";
