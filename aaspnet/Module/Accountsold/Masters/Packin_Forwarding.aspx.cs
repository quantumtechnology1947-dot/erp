...
public partial class Module_Accounts_Masters_Packin_Forwarding : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            {
                con.Open();
                string upd = "UPDATE tblPacking_Master SET Terms ='" + strTerms + "',Value='" + strValue + "' WHERE Id ='" + id + "'";
