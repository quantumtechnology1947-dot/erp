...
public partial class Module_Accounts_Masters_TourExpencess : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            {
                con.Open();
                string upd = "UPDATE tblACC_TourExpencessType SET Terms ='" + strTerms + "' WHERE Id ='" + id + "'";
