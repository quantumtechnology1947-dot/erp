<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="WarrentyTerms.aspx.cs" Inherits="Module_Accounts_Masters_WarrentyTerms" Title="ERP" Theme="Default" %>
    ...
    <table align="center" style="width: 49%" >
        ...
        <tr>
            ...
            <asp:GridView ID="GridView1" Width="100%"
              ...
              OnRowCommand="GridView1_RowCommand" CssClass="yui-datatable-theme" PageSize="10" 
...
<FooterStyle Wrap="True"></FooterStyle>
                   ...
                   <Columns>
                      ...
                      <FooterTemplate> <asp:Button ID="btnInsert" runat="server" Text="Insert" ValidationGroup="abc" 
                      OnClientClick=" return confirmationAdd()" CommandName="Add" CssClass="redbox" />
                        ...
                        <asp:Label ID="lblTerms" runat="server" Text='<%#Eval("Terms") %>'>    </asp:Label>
                         ...
                         <EditItemTemplate>
                        <asp:TextBox CssClass="box3"  ID="txtTerms1" Width="300" runat="server" ValidationGroup="Shree" Text='<%#Bind("Terms") %>'>
                        </asp:TextBox>
  ...
  <EmptyDataTemplate>
                   ...
                   <td></td>
                    <td align="center">
                         <asp:Label ID="Label2" runat="server" Font-Size="Medium" Font-Names="Times New Roman"  Font-Bold="true" Text="Terms"></asp:Label></td></tr>
                    <tr>
                    <td>
                   ...
                   <td>
                   <asp:TextBox ID="txtTerms3" CssClass="box3"  runat="server" ValidationGroup="pqr" Width="300" >
                        </asp:TextBox> 
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [tblWarrenty_Master] WHERE [Id] = @Id" 
                    InsertCommand="INSERT INTO [tblWarrenty_Master] ([Terms]) VALUES (@Terms)" 
                    SelectCommand="SELECT * FROM [tblWarrenty_Master] order by [Id] desc" 
                    UpdateCommand="UPDATE [tblWarrenty_Master] SET [Terms] = @Terms  WHERE [Id] = @Id">
                    <DeleteParameters>
