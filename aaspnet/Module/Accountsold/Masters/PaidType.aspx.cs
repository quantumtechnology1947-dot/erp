...
public partial class Module_Accounts_Masters_PaidType : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Add")
            {
                ...
                if (strTerms != "")
                {
                    SqlDataSource1.InsertParameters["Particulars"].DefaultValue = strTerms;
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            {
                con.Open();
                string upd = "UPDATE tblACC_PaidType SET Particulars ='" + strTerms + "' WHERE Id ='" + id + "'";
