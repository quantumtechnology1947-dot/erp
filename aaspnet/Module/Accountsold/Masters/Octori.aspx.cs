...
public partial class Module_Accounts_Masters_Octori : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
      try
        {  
            ...
            {
                con.Open();
                string upd = "UPDATE tblOctroi_Master SET Terms ='" + strTerms + "',Value='" + strValue + "' WHERE Id ='" + id + "'";
