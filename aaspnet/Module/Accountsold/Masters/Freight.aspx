<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Freight.aspx.cs" Inherits="Module_Accounts_Masters_Freight" Title="ERP" Theme="Default" %>
...
<FooterStyle Wrap="True"></FooterStyle>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [tblFreight_Master] WHERE [Id] = @Id" 
                    InsertCommand="INSERT INTO [tblFreight_Master] ([Terms]) VALUES (@Terms)" 
                    SelectCommand="SELECT * FROM [tblFreight_Master]  order by [Id] desc" 
                    UpdateCommand="UPDATE [tblFreight_Master] SET [Terms] = @Terms  WHERE [Id] = @Id">
                    <DeleteParameters>
