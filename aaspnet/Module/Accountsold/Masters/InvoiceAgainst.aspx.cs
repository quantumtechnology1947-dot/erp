...
public partial class Module_Accounts_Masters_InvoiceAgainst : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            {
                con.Open();
                string upd = "UPDATE tblACC_InvoiceAgainst SET Against ='" + strTerms + "' WHERE Id ='" + id + "'";
