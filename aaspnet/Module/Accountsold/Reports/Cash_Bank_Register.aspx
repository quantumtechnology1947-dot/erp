<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Cash_Bank_Register.aspx.cs" Inherits="Module_Accounts_Reports_Cash_Bank_Register" Title="ERP" Theme="Default"   Culture="en-GB"  %>
