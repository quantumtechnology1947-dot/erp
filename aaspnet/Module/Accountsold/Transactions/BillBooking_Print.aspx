<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BillBooking_Print.aspx.cs" Inherits="Module_Accounts_Transactions_BillBooking_Print" Title="ERP" Theme="Default" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Fin Year">
                          ...
                          <asp:HyperLinkField DataNavigateUrlFields="Id,Key" 
                            DataNavigateUrlFormatString="~/Module/Accounts/Transactions/BillBooking_Print_Details.aspx?Id={0}&Key={1}&f=1&ModId=11&SubModId=62" 
