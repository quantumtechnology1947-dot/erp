...
public partial class Module_Accounts_Transactions_TourVoucher_Edit : System.Web.UI.Page
{
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Sel")
            {
                ...
                Response.Redirect("TourVoucher_Edit_Details.aspx?Id=" + Id + "&TIMId=" + TIMId + "&ModId=11&SubModId=126");
            }
        }
        catch (Exception es) { }
