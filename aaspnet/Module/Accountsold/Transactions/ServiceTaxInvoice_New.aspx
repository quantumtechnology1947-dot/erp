<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ServiceTaxInvoice_New.aspx.cs" Inherits="Module_Accounts_Transactions_ServiceTaxInvoice_New" Title="ERP" Theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
     ...
     <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td style="background:url(../../../images/hdbg.JPG); height:21px" class="fontcsswhite" >&nbsp;<b>Service Tax Invoice - New</b></td>
        </tr>
        <tr>
        <td height="25">
        ...
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" AllowPaging="false"  
                    ...
                    onpageindexchanging="GridView1_PageIndexChanging" PageSize="18">
                    <Columns>
