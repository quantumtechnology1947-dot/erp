            ...
            //if (!IsPostBack)
            {
                ...
                if (GQNId != 0)
                {
                    ...
                    if (Isvat == 1)
                    {
                        ...
                        TAmt = bAmt + vat1+ExserAmt + Freight;
                ...
                else if (GSNId != 0)
                {
                    ...
                    {
                        lblVatCst.Text = "CST";
                        bAmt = ((Convert.ToDouble(GSNAmt)) + PfAmt + ExserAmt);
                        double vat2 = ((bAmt * vatVal) / 100);
                        double cst = bAmt + vat2;
                        TAmt = cst;
    ...
    public double Calculation()
    {
        ...
        try
        {
            ...
            if (CkBCD.Checked == true)
            {
                ...
                if (Isvat == 1)
                {
                    VatCst = Math.Round((((ValueWithDuty + getFreight) * getVatCst) / 100), 2);
                }
                else if (Iscst == 1)
                {
            ...
            {
                ExCal = Math.Round(((Amt + PFCal) * getExcise / 100), 2);
                ExBasicCal = Math.Round(((Amt + PFCal) * getExciseBasic / 100), 2);
                ExEDUCal = Math.Round((ExBasicCal * getExciseEDU / 100), 2);
                ExSHECal = Math.Round((ExBasicCal * getExciseSHE / 100), 2);
                ...
                if (Isvat == 1)
                {
                    VatCst = Math.Round((((Amt + PFCal + ExCal + getFreight) * getVatCst) / 100), 2); 
                }
                else if (Iscst == 1)
                {
                    VatCst = Math.Round((((Amt + PFCal + ExCal) * getVatCst) / 100), 2);
                }
