...
public partial class Module_Accounts_Transactions_ProformaInvoice_Delete : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Sel")
        {
            try
            {
                ...
                Response.Redirect("ProformaInvoice_Delete_Details.aspx?InvNo=" + Server.UrlEncode(fun.Encrypt(invno)) + "&InvId=" + Server.UrlEncode(fun.Encrypt(InvId)) + "&cid=" + Server.UrlEncode(fun.Encrypt(custcode)) + "&ModId=11&SubModId=104");
