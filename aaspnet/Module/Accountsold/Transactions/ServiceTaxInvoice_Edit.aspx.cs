...
public partial class Module_Accounts_Transactions_ServiceTaxInvoice_Edit : System.Web.UI.Page
{
     ...
     protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
     {
         if (e.CommandName == "Sel")
         {
              try
             {
                 ...
                 Response.Redirect("ServiceTaxInvoice_Edit_Details.aspx?InvNo=" + Server.UrlEncode(fun.Encrypt(invno)) + "&invid=" + Server.UrlEncode(fun.Encrypt(invid)) + "&cid=" + Server.UrlEncode(fun.Encrypt(custcode)) + "&ModId=11&SubModId=52");
