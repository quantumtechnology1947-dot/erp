<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TourVoucher.aspx.cs" Inherits="Module_Accounts_Transactions_TourVoucher" Title="ERP" Theme="Default" %>
...
<table align="left" cellpadding="0" cellspacing="0" width="100%">
    ...
    <asp:GridView ID="GridView2" runat="server" CssClass="yui-datatable-theme" 
        ...
        <Columns>
            ...
            <ItemTemplate>
                <asp:LinkButton ID="LinkButton1" runat="server"  CommandName="Sel"  Text='<%# Eval("TINo") %>'></asp:LinkButton>
