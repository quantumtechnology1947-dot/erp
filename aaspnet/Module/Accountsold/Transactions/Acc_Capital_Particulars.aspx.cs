...
public partial class Module_Accounts_Transactions_Acc_Capital_Particulars : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Sel")
        {
            ...
            Response.Redirect("Acc_Capital_Part_Details.aspx?MId=" + id + "&ModId=11&SubModId=");
        }
    }
