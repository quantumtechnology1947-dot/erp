<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"  AutoEventWireup="true"   CodeFile="ProformaInvoice_Print_Details.aspx.cs" Inherits="Module_Accounts_Transactions_ProformaInvoice_Print_Details" Title="ERP" Theme="Default" %>
            ...
            <td align="center" class="style3">
               <asp:Panel ID="Panel1" runat="server" Height="450px" ScrollBars="Auto" 
                    ...
                    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
                        <Report FileName="~/Module/Accounts/Reports/ProformaInvoice.rpt">
                        </Report>
