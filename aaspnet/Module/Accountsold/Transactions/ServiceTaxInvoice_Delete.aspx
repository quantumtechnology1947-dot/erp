<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ServiceTaxInvoice_Delete.aspx.cs" Inherits="Module_Accounts_Transactions_ServiceTaxInvoice_Delete" Title="ERP" Theme="Default" %>
 ...
 <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td style="background:url(../../../images/hdbg.JPG); height:21px" class="fontcsswhite" >
                <b>Service Tax Invoice - Delete</b></td>
        </tr><tr>
        <td height="25">
