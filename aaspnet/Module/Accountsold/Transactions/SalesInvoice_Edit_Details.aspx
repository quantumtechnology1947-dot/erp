<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SalesInvoice_Edit_Details.aspx.cs" Inherits="Module_Accounts_Transactions_SalesInvoice_Edit_Details" Title="ERP" Theme="Default" %>
            ...
            <td colspan="3">
                <table align="left" cellpadding="0" cellspacing="0" class="style2" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lbltrafficNo" runat="server"></asp:Label>
                                                   </td>
                        <td>
                            Rate of Duty</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtRRGCNo" runat="server" CssClass="box3"></asp:TextBox>
                    ...
                    <tr>
                        <td height="21">
                            &nbsp;If by motor vehicle , it&#39;s regist. number</td>
                        <td>
                            <asp:TextBox ID="TxtRegistrationNo" runat="server" CssClass="box3"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="ReqregistNo" runat="server" 
                                ControlToValidate="TxtRegistrationNo" ErrorMessage="*" ValidationGroup="A"></asp:RequiredFieldValidator>
                        </td>
                        <td>
                            Nature Of Removal</td>
                        <td>
...
<asp:RegularExpressionValidator runat="server" 
                                ...
                                ID="RegDateOfRemovalEdit"></asp:RegularExpressionValidator>
                        </td>
                        <td>
                            Time Of Removal</td>
                        <td>
            ...
            <td colspan="3">
                <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
                    ...
                    runat="server" CompletionInterval="100" CompletionSetCount="1" 
                            ...
                            <asp:Button ID="Button1" runat="server" CssClass="redbox" Text="Search" 
                                ...
                                <td class="style13" width="10%">City</td><td class="style13"><asp:DropDownList 
                                    ...
                                    <asp:TextBox 
                                        ID="TxtByEmail" runat="server" CssClass="box3" Width="160px"></asp:TextBox><asp:RequiredFieldValidator ID="ReqByEmail" runat="server" 
                                    ...
                                    <asp:TextBox 
                                        ID="TxtByTINVATNo" runat="server" CssClass="box3" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="ReqByTinVatNo" runat="server" 
                                    ...
                                    <asp:TextBox 
                                    ID="TxtByTINCSTNo" runat="server" CssClass="box3" Width="150px"></asp:TextBox><asp:RequiredFieldValidator ID="ReqByTInCStNo" runat="server" 
                    ...
                    runat="server" CompletionInterval="100" CompletionSetCount="1" 
                                ...
                                <td 
                                    class="style20" width="15%" height="25">Country</td><td class="style15" 
                                    width="20%"><asp:DropDownList 
                                    ...
                                    ID="DrpCoCity" runat="server" AutoPostBack="True"></asp:DropDownList></td></tr><tr><td 
                                        ...
                                        TIN / VAT No.</td><td>
                                        <asp:TextBox 
                                        ID="TxtCoTinVatNo" runat="server" CssClass="box3" Width="170px"></asp:TextBox><asp:RequiredFieldValidator ID="ReqCTinVatno" runat="server" 
                                    ...
                                    <asp:TextBox 
                                        ID="TxtCoTinCSTNo" runat="server" CssClass="box3" Width="160px"></asp:TextBox><asp:RequiredFieldValidator ID="ReqCTINcstno" runat="server" 
                    ...
                    <cc1:TabPanel ID="TabPanel3"    runat="server" HeaderText="Goods">
                        ...
                        <ContentTemplate><table align="left" cellpadding="0" cellspacing="0" class="style2" 
                                ...
                                <asp:Panel ID="Panel1" runat="server" Height="220px" ScrollBars="Auto">
                    ...
                    <cc1:TabPanel ID="TabPanel4" runat="server" HeaderText="Taxation">
                        ...
                        <ContentTemplate><table align="left" cellpadding="0" cellspacing="0"  width="750"><tr>
                            ...
                            <td height="25">
                                &nbsp;&nbsp;&nbsp;Other Amount :
                                <asp:TextBox ID="TxtOtherAmt" runat="server" CssClass="box3">0</asp:TextBox>
                            ...
                            <tr>
                                <td height="25">
                                    &nbsp;Deduction&nbsp;</td>
                                <td height="25" width="20%" style="width: 30%" colspan="2">
                            ...
                            <tr>
                                <td height="25">
                                    &nbsp;P&amp;F&nbsp;</td>
                                <td height="25" width="20%" style="width: 35%" colspan="2">
                                    :<asp:TextBox ID="TxtPf" runat="server" CssClass="box3"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator12" 
                                        ...
                                        ValidationExpression="^\d{1,15}(\.\d{0,3})?$" ValidationGroup="A"></asp:RegularExpressionValidator>
                                    <asp:DropDownList ID="DrpPAF" runat="server">
                                        <asp:ListItem Text="Amt(Rs)" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Per(%)" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td height="25" width="20%" style="width: 35%" colspan="2">
                                    :<asp:DropDownList ID="DrpServiceTax" runat="server" 
                                        CssClass="box3" DataSourceID="SqlServiceTax" DataTextField="Terms" 
                                        DataValueField="Id">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td height="25">
                                    SED</td>
                                <td height="25" width="20%" style="width: 35%" colspan="2">
                                    :<asp:TextBox ID="TxtSed" runat="server" CssClass="box3"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                        ...
                                        ValidationExpression="^\d{1,15}(\.\d{0,3})?$" ValidationGroup="A"></asp:RegularExpressionValidator>
                                    <asp:DropDownList ID="DrpSED" runat="server" 
                            ...
                            <tr>
                                <td height="25">
                                    AED</td>
                                <td height="25" width="20%" style="width: 35%" colspan="2">
                                    :<asp:TextBox ID="TxtAed" runat="server" CssClass="box3"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" 
                                        ...
                                        ValidationExpression="^\d{1,15}(\.\d{0,3})?$" ValidationGroup="A"></asp:RegularExpressionValidator>
                                    <asp:DropDownList ID="DrpAED" runat="server">
                                        <asp:ListItem Text="Amt(Rs)" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Per(%)" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td height="25" width="20%" style="width: 35%" colspan="2">
                                    :<asp:TextBox ID="Txtfreight" runat="server" CssClass="box3"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" 
                                        ...
                                        ValidationExpression="^\d{1,15}(\.\d{0,3})?$" ValidationGroup="A"></asp:RegularExpressionValidator>
                                    <asp:DropDownList ID="DrpFreight" runat="server">
                                        <asp:ListItem Text="Amt(Rs)" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Per(%)" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr><td 
                                ...
                                <td height="25" width="17%" style="width: 32%" colspan="2">
                                    :<asp:DropDownList ID="DrpCst" runat="server">
                                        <asp:ListItem Text="C.S.T.(With C Form)" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="C.S.T.(Without C Form)" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="DrpVAT" runat="server" 
                                        DataSourceID="SqlVAT" DataTextField="Terms" DataValueField="Id">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td height="25">
                                    &nbsp;Insurance&nbsp;</td>
                                <td height="25" width="17%" colspan="2">
                                    :<asp:TextBox ID="TxtInsurance" runat="server" CssClass="box3"></asp:TextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator11" 
                                        ...
                                        ValidationExpression="^\d{1,15}(\.\d{0,3})?$" ValidationGroup="A"></asp:RegularExpressionValidator>
                                    <asp:DropDownList ID="DrpInsurance" runat="server">
                                        <asp:ListItem Text="Amt(Rs)" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Per(%)" Value="1"></asp:ListItem>
                                    </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;
