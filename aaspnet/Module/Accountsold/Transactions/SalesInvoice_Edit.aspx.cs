...
public partial class Module_Accounts_Transactions_SalesInvoice_Edit : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Sel")
        {
             try
            {
                ...
                Response.Redirect("SalesInvoice_Edit_Details.aspx?InvNo=" + Server.UrlEncode(fun.Encrypt(invno)) + "&invId=" + Server.UrlEncode(fun.Encrypt(invId)) + "&cid=" + Server.UrlEncode(fun.Encrypt(custcode)) + "&ModId=11&SubModId=51");
