<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SalesInvoice_Delete_Details.aspx.cs" Inherits="Module_Accounts_Transactions_SalesInvoice_Delete_Details" Title="ERP" Theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
 <table align="left" cellpadding="0" cellspacing="0"  width="100%">
        <tr>
            <td style="background:url(../../../images/hdbg.JPG); height:21px" class="fontcsswhite" >&nbsp;<b>Sales Invoice - Delete</b></td>
        </tr>
        <tr>
            <td>
