<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Acc_Sundry_CustList.aspx.cs" Inherits="Module_Accounts_Transactions_Acc_Sundry_CustList" Theme="Default" Title="ERP" %>
   ...
   <td align="Left">
    <asp:Panel ID="Panel1" ScrollBars="Auto"  Width="100%" Height="430px"  runat="server">
      ...
      <asp:TemplateField HeaderText="SN" ItemStyle-HorizontalAlign="Right">
       ...
       <ItemTemplate>       
        <asp:LinkButton ID="LinkButton1" CommandName="Sel" Text='<%#Eval("CustName") %>'  runat="server"></asp:LinkButton>
       </ItemTemplate>
           <FooterTemplate>
       ...
       <ItemTemplate>       
           <asp:Label ID="lblOpAmt" runat="server" Text="0"></asp:Label>
       </ItemTemplate>
       <FooterTemplate>
       <asp:Label ID="TotOP" runat="server" Text="0"></asp:Label>
       </FooterTemplate>
       ...
       <ItemTemplate>       
           <asp:Label ID="lblDrAmt" runat="server" Text='<%#Eval("TotAmt") %>'></asp:Label>
       </ItemTemplate>
       <FooterTemplate>
       ...
       <ItemTemplate>       
           <asp:Label ID="lblCrAmt" runat="server" Text="0"></asp:Label>
       </ItemTemplate>
       <FooterTemplate>
