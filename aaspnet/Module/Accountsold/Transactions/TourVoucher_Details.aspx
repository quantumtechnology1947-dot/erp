<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TourVoucher_Details.aspx.cs" Inherits="Module_Accounts_Transactions_TourVoucher_Details" Title="ERP" Theme="Default" %>
...
<table align="left" cellpadding="0" cellspacing="0" width="100%">
      <tr>
            <td align="left" height="21" style="background:url(../../../images/hdbg.JPG)" height="21" 
                class="fontcsswhite">
                <b>&nbsp;Tour Voucher New Details </b></td>
...
<asp:GridView ID="GridView2" runat="server" CssClass="yui-datatable-theme" 
        Width="100%" AutoGenerateColumns="False" DataKeyNames="TADId" 
        ShowFooter="True" >
        
        <Columns>
        <asp:TemplateField HeaderText="SN"><ItemTemplate><%#Container.DataItemIndex+1 %></ItemTemplate><ItemStyle Width="2%"  HorizontalAlign="Right"/>
</asp:TemplateField>

<asp:TemplateField HeaderText="TADId" Visible="False"><ItemTemplate><asp:Label ID="lblTADId" runat="server" Text='<%# Bind("TADId") %>'></asp:Label>
...
<asp:TemplateField HeaderText="Remarks"><ItemTemplate><asp:Label ID="lblADRemarks" runat="server" Text='<%# Bind("Remarks") %>' ></asp:Label>
            
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="20%" />
</asp:TemplateField>

<asp:TemplateField HeaderText="Sanctioned Amount"><ItemTemplate><asp:TextBox ID="txtAmount" CssClass="box3"  Text="0"   Width="90%" runat="server"> </asp:TextBox><asp:RequiredFieldValidator ID="ReqtxtAmount" runat="server" 
            ControlToValidate="txtAmount" ErrorMessage="*" ValidationGroup="A"> </asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="RegtxtAmount" runat="server" 
             ValidationGroup="A" ControlToValidate="txtAmount" ErrorMessage="*" ValidationExpression="^\d{1,15}(\.\d{0,3})?$"> </asp:RegularExpressionValidator>
            
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="15%" />
</asp:TemplateField>

<asp:TemplateField HeaderText="Remarks"><ItemTemplate><asp:TextBox ID="txtRemarks" CssClass="box3"   Text=""  Width="98%" runat="server"> </asp:TextBox>  
        </ItemTemplate><ItemStyle HorizontalAlign="Left" Width="20%" />
</asp:TemplateField>   
    </Columns>
    ...
    </EmptyDataTemplate><PagerSettings PageButtonCount="40" />
...
<ContentTemplate>
        ...
        Width="100%" AutoGenerateColumns="False" DataKeyNames="TATId" PageSize="3" 
                    ShowFooter="True">
        <Columns>
           ...
           <asp:Label ID="lblATTotalAmount" runat="server" Text='<%# Bind("TotalAmount") %>' ></asp:Label>
            ...
            <ItemTemplate>
            <asp:TextBox ID="txtATAmount" CssClass="box3"  Text="0"   Width="85%" runat="server"></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="Remarks">
            <ItemTemplate>
            <asp:TextBox ID="txtATRemarks" CssClass="box3"   Text=""  Width="95%" runat="server">
             </asp:TextBox>            
...
<td align="center" height="25px" valign="middle">
    ...
    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="redbox" 
        ValidationGroup="A" OnClientClick="return confirmationAdd();"
