<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Debit_Note.aspx.cs" Inherits="Module_Accounts_Transactions_Debit_Note" Title="ERP" Theme="Default" %>
            ...
            <td align="left">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True"  DataKeyNames="Id"
                    ...
                    <Columns>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblDebitno" runat="server" Text='<%#Eval("DebitNo")%>'></asp:Label>
                            </ItemTemplate> 
                        ...
                        DataTextField="Description" DataValueField="Id"  onselectedindexchanged="DrpList2_SelectedIndexChanged">
                         ...
                         <asp:TemplateField HeaderText="Debit To">
                        <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:Label ID="Label4" runat="server" style="font-weight: 700" Text="Debit To"></asp:Label>
                        </td>
                        <td align="center">
