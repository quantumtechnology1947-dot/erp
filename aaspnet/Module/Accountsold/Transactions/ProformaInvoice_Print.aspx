<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ProformaInvoice_Print.aspx.cs" Inherits="Module_Accounts_Transactions_ProformaInvoice_Print" Title="ERP" Theme="Default" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table align="left" cellpadding="0" cellspacing="0" class="style2">
        <tr>
            <td style="background:url(../../../images/hdbg.JPG); height:21px" class="fontcsswhite" >&nbsp;<b>Proforma Invoice - Print</b></td>
        </tr>
                    ...
                    <Columns>
                      ...
                      <asp:LinkButton ID="Btn1"   Text="Select" CommandName="Sel" runat="server">
                       ...
                       <%-- <asp:ListItem Text="ALL COPYES" Value="ALL"> </asp:ListItem>--%>
                        ...
                        <asp:ListItem Text="EXTRA COPY" Value="EXTRA COPY [NOT FOR CENVAT PURPOSE]"> </asp:ListItem>             
                        </asp:DropDownList>
                        </ItemTemplate>
