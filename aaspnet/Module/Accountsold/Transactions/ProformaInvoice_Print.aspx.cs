...
public partial class Module_Accounts_Transactions_ProformaInvoice_Print : System.Web.UI.Page
{
    ...
    public void bindgrid(string Cid, String wn)
    {
        ...
        try
        {
            ...
            string sqlInv = fun.select("Id,FinYearId,SysDate,InvoiceNo,WONo,PONo,CustomerCode", "tblACC_ProformaInvoice_Master", "CompId='" + CompId + "' And FinYearId<='" + FinYearId + "'" + I + y + z + " Order by InvoiceNo DESC");
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Sel")
        {
            try
            {
                ...
                Response.Redirect("ProformaInvoice_Print_Details.aspx?InvNo=" + invno + "&InvId=" + InvId + "&cid=" + custcode + "&PT=" + pt + "&ModId=11&SubModId=104&Key=" + getRandomKey + "");
            }
            catch (Exception ex) { }
        }
    }
